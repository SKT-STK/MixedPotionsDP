...
execute if score @n[tag=mpdp.this3] mpdp.level matches ..2 if entity @s[nbt={SelectedItem:{id:"minecraft:potion"}},nbt=!{SelectedItem:{components:{"minecraft:potion_contents":{potion:"minecraft:water"}}}},nbt=!{SelectedItem:{components:{"minecraft:potion_contents":{custom_effects:[{}]}}}}] run return run function mpdp:interacted/fill
